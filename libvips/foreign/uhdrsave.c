 ...
 *     * @interlace: `gboolean`, generate an interlaced (progressive) jpeg
 *     * @subsample_mode: `VipsForeignSubsample`, select chroma subsample mode
 *     * @trellis_quant: `gboolean`, apply trellis quantization
 *     * @overshoot_deringing: `gboolean`, apply overshoot de-ringing
 *     * @optimize_scans: `gboolean`, split DCT coefficients into separate scans
 *     * @quant_table: `gint`, use predefined quantization table index
 *     * @restart_interval: `gint`, add restart markers every specified number of mcu
 *
 * ::: seealso
